...
let survivors = [
    new Character("nerd", 0.5, 0.3, 0.5),
    new Character("blonde", 0.6, 0.2, 0.3),
    new Character("black", 0.7, 0.3, 0.5),
    new Character("hero", 0.3, 0.7, 0.8),
    new Character("sportif", 0.4, 0.8, 0.6)
];

let deadPeople = [];


let jason = new Killer("Jason", 50);
